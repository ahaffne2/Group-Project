...
After examining the csv file, once the above code is ran the remaining NAs are the only NAs for that row.
We can fill those NAs with the mean for that column so that we can keep the data.
This will result in better training and testing for our model. 
